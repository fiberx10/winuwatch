...
export const RunerUp = (data: {
  runUpPrize: RunUpPrize & {
    ticket: Ticket & { Competition: Competition; Order: Order };
  };
}) => {
  return (
    <>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ margin: "0" }}>
                a run up prize for Winuwatch {data.runUpPrize.ticket.Order?.id}
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    a discount of{" "}
                    {data.runUpPrize.ticket.Competition?.run_up_prize?.toString() ||
                      "0"}
                  </p>
                </div>
              </div>
...
export default (order: Parameters<typeof RunerUp>[0]) =>
  renderToString(RunerUp(order));
